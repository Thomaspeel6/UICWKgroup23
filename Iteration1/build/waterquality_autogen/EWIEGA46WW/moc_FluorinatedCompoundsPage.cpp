...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFluorinatedCompoundsPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFluorinatedCompoundsPageENDCLASS_t qt_meta_stringdata_CLASSFluorinatedCompoundsPageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 24)   // "FluorinatedCompoundsPage"
    },
    "FluorinatedCompoundsPage"
};
