...
namespace {
struct qt_meta_stringdata_RawData_t {
    uint offsetsAndSizes[2];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_RawData_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_RawData_t qt_meta_stringdata_RawData = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_RawData[] = {
...
Q_CONSTINIT const QMetaObject RawData::staticMetaObject = { {
    ...
    qt_meta_stringdata_RawData.offsetsAndSizes,
    qt_meta_data_RawData,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_RawData_t,
        // Q_OBJECT / Q_GADGET
...
void *RawData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RawData.stringdata0))
