...
namespace {
struct qt_meta_stringdata_waterQualityWindow_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_waterQualityWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_waterQualityWindow_t qt_meta_stringdata_waterQualityWindow = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_waterQualityWindow[] = {
...
Q_CONSTINIT const QMetaObject waterQualityWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_waterQualityWindow.offsetsAndSizes,
    qt_meta_data_waterQualityWindow,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_waterQualityWindow_t,
        // Q_OBJECT / Q_GADGET
...
void *waterQualityWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_waterQualityWindow.stringdata0))
