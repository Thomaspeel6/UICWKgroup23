...
#include "FluorinatedCompoundsPage.hpp"  // Add the include for FluorinatedCompoundsPage
...
private:
    ...
    FluorinatedCompoundsPage* fluorinatedPage;  // Declare fluorinatedPage as a member
    QTableView* table;
