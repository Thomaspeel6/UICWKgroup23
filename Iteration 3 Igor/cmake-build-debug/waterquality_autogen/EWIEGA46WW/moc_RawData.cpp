...
namespace {
struct qt_meta_tag_ZN7RawDataE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7RawDataE = QtMocHelpers::stringData(
    "RawData"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7RawDataE[] = {
...
Q_CONSTINIT const QMetaObject RawData::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7RawDataE.offsetsAndSizes,
    qt_meta_data_ZN7RawDataE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7RawDataE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<RawData *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *RawData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7RawDataE.stringdata0))
