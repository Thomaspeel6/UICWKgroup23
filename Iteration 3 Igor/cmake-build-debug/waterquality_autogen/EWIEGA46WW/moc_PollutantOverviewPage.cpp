...
namespace {
struct qt_meta_tag_ZN21PollutantOverviewPageE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN21PollutantOverviewPageE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21PollutantOverviewPageE[] = {
...
Q_CONSTINIT const QMetaObject PollutantOverviewPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21PollutantOverviewPageE.offsetsAndSizes,
    qt_meta_data_ZN21PollutantOverviewPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21PollutantOverviewPageE_t,
        // Q_OBJECT / Q_GADGET
...
void PollutantOverviewPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (PollutantOverviewPage::*)();
            if (_q_method_type _q_method = &PollutantOverviewPage::returnToDashboard; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *PollutantOverviewPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21PollutantOverviewPageE.stringdata0))
